...
exports.sendEmailRecovery = void 0;
const nodemailer_1 = require("../nodemailler/nodemailer");
const sendEmailRecovery = (email, token) => __awaiter(void 0, void 0, void 0, function* () {
    const messsage = `
    <!doctype html>
<html lang="en-US">
...
<body marginheight="0" topmargin="0" marginwidth="0" style="margin: 0px; background-color: #f2f3f8;" leftmargin="0">
    ...
    `;
    const respEmail = (0, nodemailer_1.sendEmail)(email, messsage, "Recuperação de senha");
    return respEmail;
});
exports.sendEmailRecovery = sendEmailRecovery;
