import { sendEmail } from "../nodemailler/nodemailer";

export const sendEmailRecovery = async (email: string,token:string) => {
    const messsage = `
    <!doctype html>
<html lang="en-US">
...
<body marginheight="0" topmargin="0" marginwidth="0" style="margin: 0px; background-color: #f2f3f8;" leftmargin="0">
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <p
                                ...
                                &copy; <strong>www.m6Grupo02.com</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td style="height:80px;">&nbsp;</td>
    ...
    `;
    const respEmail = sendEmail(email, messsage, "Recuperação de senha");
